...
define('OB_DB_USER','ob'); // database user
define('OB_DB_PASS','ob'); // database password
define('OB_DB_HOST','localhost'); // database hostname
define('OB_DB_NAME','ob'); // database name
...
define('OB_MEDIA','/5');
define('OB_MEDIA_UPLOADS','/5/uploads'); // can be subdirectory of OB_MEDIA, but doesn't need to be.
define('OB_MEDIA_ARCHIVE','/5/archive'); // can be subdirectory of OB_MEDIA, but doesn't need to be.
define('OB_CACHE','/5/cache');

define('OB_SITE','http://ec2-3-95-7-139.compute-1.amazonaws.com'); // where do you access OB?

define('OB_EMAIL_REPLY','henry.mcbrien@hotmail.com'); // emails to users come from this address
...
define('OB_UPDATES_PW','$2y$10$WchMo3N8yWghWsL5F17Awe8.u6ylR/xeXj0oFbZvhsfSmD/l0.h0O'); // get password hash with: php -r "echo password_hash('password',PASSWORD_DEFAULT).\"\n\";"
